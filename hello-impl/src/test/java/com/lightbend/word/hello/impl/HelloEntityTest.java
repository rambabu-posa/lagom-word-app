package com.lightbend.word.hello.impl;
...
import com.lightbend.word.hello.impl.HelloCommand.Hello;
import com.lightbend.word.hello.impl.HelloCommand.UseGreetingMessage;
import com.lightbend.word.hello.impl.HelloEvent.GreetingMessageChanged;
